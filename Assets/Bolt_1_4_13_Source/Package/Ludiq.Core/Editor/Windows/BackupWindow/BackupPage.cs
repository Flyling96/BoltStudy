...
namespace Ludiq
{
	public class BackupPage : Page
	{
		public BackupPage(): base()
		{
			title = "Backup";
			shortTitle = "Backup";
			icon = LudiqCore.Resources.LoadIcon("Icons/Windows/BackupWindow/BackupPage.png");
		}
		...
		protected override void OnContentGUI()
		{
			...
			if (createdBackup)
			{
				GUILayout.Label(new GUIContent(" Backup created", LudiqCore.Icons.successState?[IconSize.Small]), Styles.backupCreatedLabel);
			}
			else
			{
