...
namespace Ludiq
{
	public abstract class Metadata : IAttributeProvider, IList, IDictionary
	{
		...
		public void Unlink()
		{
			...
			if (LudiqCore.Configuration.developerMode && LudiqCore.Configuration.trackMetadataState)
			{
		...
		protected virtual void OnValueChange(object previousValue)
		{
			...
			if (PluginContainer.initialized && LudiqCore.Configuration.developerMode && LudiqCore.Configuration.trackMetadataState)
			{
				Debug.LogFormat
				(
