...
namespace Ludiq
{
	public class MemberOptionTree : FuzzyOptionTree
	{
		...
		private class Favorites : ICollection<object>
		{
			...
			private IEnumerable<Member> validFavorites => LudiqCore.Configuration.favoriteMembers.Where(tree.codebase.ValidateMember);
			...
			private static readonly ICollection<object> favorites = new VariantCollection<object, Member>(LudiqCore.Configuration.favoriteMembers);
		}
