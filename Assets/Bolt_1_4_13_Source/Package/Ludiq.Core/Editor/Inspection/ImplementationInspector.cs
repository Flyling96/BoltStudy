	...
	public class ImplementationInspector<T> : Inspector where T : class
	{
		...
		public static class Styles
		{
			static Styles()
			{
				...
				compactSelectorWithoutIconContent = new GUIContent(LudiqCore.Resources.LoadTexture("TypeSelector/TypeSelector.png", new TextureResolution[] { 9, 18 }, CreateTextureOptions.PixelPerfect)?[9]);
