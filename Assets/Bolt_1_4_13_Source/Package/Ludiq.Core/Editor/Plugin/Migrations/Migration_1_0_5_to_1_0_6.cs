...
namespace Ludiq
{
	...
	internal class Migration_1_0_5_to_1_0_6 : LudiqCoreMigration
	{
		...
		public override void Run()
		{
			...
			{
				if (!LudiqCore.Configuration.assemblyOptions.Contains(defaultAssemblyOption))
				{
					LudiqCore.Configuration.assemblyOptions.Add(defaultAssemblyOption);
				}
			}

			foreach (var defaultTypeOption in defaultTypeOptions)
			{
				if (!LudiqCore.Configuration.typeOptions.Contains(defaultTypeOption))
				{
					LudiqCore.Configuration.typeOptions.Add(defaultTypeOption);
				}
			}
