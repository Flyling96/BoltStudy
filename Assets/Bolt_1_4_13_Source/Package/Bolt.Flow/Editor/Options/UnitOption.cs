...
namespace Bolt
{
	...
	public class UnitOption<TUnit> : IUnitOption where TUnit : IUnit
	{
		...
		public string label => LudiqCore.Configuration.humanNaming ? labelHuman : labelProgrammer;
		...
		public string haystack => LudiqCore.Configuration.humanNaming ? haystackHuman : haystackProgrammer;
		...
		{
			return BoltFlowNameUtility.UnitTitle(unitType, false);
		}
