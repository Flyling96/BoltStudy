...
namespace Ludiq
{
		...
		where TGraph : class, IGraph
	{
		...
		public void ViewElements(IEnumerable<IGraphElement> elements)
		{
			...
			TweenViewport(pan, zoom, LudiqGraphs.Configuration.overviewSmoothing);
		}
		...
		public virtual void OnToolbarGUI()
		{
			...
			LudiqGraphs.Configuration.carryChildren = GUILayout.Toggle(LudiqGraphs.Configuration.carryChildren, "Carry", LudiqStyles.toolbarButton);
			...
			if (LudiqCore.Configuration.developerMode)
			{
				...
				LudiqGraphs.Configuration.debug = GUILayout.Toggle(LudiqGraphs.Configuration.debug, "Debug", LudiqStyles.toolbarButton);
